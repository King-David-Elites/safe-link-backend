  ...
  <table class="email-container">
    ...
    <tr>
      <td class="email-body">
        ...
        <p>Hi ${user.username}, your account has been created but you have to activate it.</p>
        <p>Kindly click on the button below to verify your account. Please ignore this email if you didn't initiate this action.</p>
        <p><strong>This link will expire in 15 minutes.</strong></p>
        <a href="${settings.frontendUrl}/verify-email/${token}" class="btn">Verify Account</a>
