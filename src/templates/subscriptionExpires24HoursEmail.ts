  ...
  <table class="email-container">
    ...
    <tr>
      <td class="email-body">
        ...
        <p>This is a gentle reminder that your SafeLink subscription will automatically renew by this same time tomorrow.</p>
        <p>If you wish to cancel your subscription, please do so on your account's profile section.</p>
