...
export const subscriptionExpiryEmailHTML = (user: IUser) => {
                            ...
                            <tr>
                              <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;" align="left">
                                ...
                                <div style="line-height: 160%; text-align: center; word-wrap: break-word;">
                                  <p style="line-height: 160%;">Hi ${user.username},</p>

                                  <p style="line-height: 160%;"> Your SafeLink subscription is almost up! In just 72 hours, your access to our platform will expire.</p>

                                  <p style="line-height: 160%;">To continue enjoying the benefits of SafeLink, please renew your subscription.</p>

                                  <p style="line-height: 160%;">To renew your subscription and keep your business running smoothly, click the link below. Your subscription will only start counting after your present subscription expires.</p>

                                  <p style="line-height: 160%;"> <a href="www.joinsafelink.com/pricing">www.joinsafelink.com </a></p>
                                  <p style="line-height: 160%;">Here's to a brighter future for your business! </p>
                                  <p style="line-height: 160%;"> Best regards,
                                  </br>The Safelink Team
