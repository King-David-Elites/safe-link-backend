...
const InventorySchema = new mongoose_1.default.Schema({
    ...
    owner: { type: mongoose_1.Types.ObjectId, ref: collections_1.default.user, required: true },
});
const Inventory = mongoose_1.default.model(collections_1.default.inventory, InventorySchema);
