...
exports.verifyEmailHTML = void 0;
const settings_1 = __importDefault(require("../constants/settings"));
const verifyEmailHTML = (user, token) => {
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    >
                                      ...
                                      [endif]-->
                                      <div align="center">
                                        <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href=${settings_1.default.frontendUrl}/verify-email/${token} style="height:37px; v-text-anchor:middle; width:100px;" arcsize="11%"  stroke="f" fillcolor="#000000"><w:anchorlock/><center style="color:#ffffff;font-family:'Cabin',sans-serif;"><![endif]-->
                                        <a
                                          href="${settings_1.default.frontendUrl}/verify-email/${token}"
                                          target="_blank"
                                          class="v-button"
                                          style="
                                            box-sizing: border-box;
